nqn_function <- function(){
  ...
  Data <- Data %>%
    ...
    filter (Afc_Spinal_Point_y2 == 16.1)
  ...
  #export to private area with today's date
  write.csv(pivot_final, paste("C:/Users/Josh.Andrews/OneDrive - Department of Health and Social Care/Nurse Data/Outputs/Joiners Band 5 Headcount/Nurse",str_replace_all(Sys.Date(),"-",""),"joiners_leavers",long_format$Date_from[1],".csv"))
}  

nurse_nationality <- function() {
  #Amend column names so the dots are replaced with spaces
  colnames(Raw_Data_y1) <- str_replace_all(colnames(Raw_Data_y1), " ", "_")
  colnames(Raw_Data_y2) <- str_replace_all(colnames(Raw_Data_y2), " ", "_")
  colnames(nationality) <- str_replace_all(colnames(nationality), " ", "_")
...
nurse_nationality_headcount <- function() {
  #Amend column names so the dots are replaced with spaces
  colnames(Raw_Data_y1) <- str_replace_all(colnames(Raw_Data_y1), " ", "_")
  colnames(Raw_Data_y2) <- str_replace_all(colnames(Raw_Data_y2), " ", "_")
  colnames(nationality) <- str_replace_all(colnames(nationality), " ", "_")
  ...
  #export to shared area with today's date
  write.csv(pivot_final, paste("C:/Users/Josh.Andrews/OneDrive - Department of Health and Social Care/Nurse Data/Outputs/Nurses/Nurse",str_replace_all(Sys.Date(),"-",""),"joiners_leavers headcount",long_format$Date_from[1],".csv"))
}

nurse_nationality_cumulative <- function() {
  #Amend column names so the dots are replaced with spaces
  colnames(Raw_Data_y1) <- str_replace_all(colnames(Raw_Data_y1), " ", "_")
  colnames(Raw_Data_y2) <- str_replace_all(colnames(Raw_Data_y2), " ", "_")
  colnames(nationality) <- str_replace_all(colnames(nationality), " ", "_")
...
nurse_trust <- function() {
  ...
  #export to shared area with today's date
  write.csv(long_format,paste("C:/Users/Josh.Andrews/OneDrive - Department of Health and Social Care/Nurse Data/Outputs/Nurses/Nurse",str_replace_all(Sys.Date(),"-",""),"joiners_leavers_trust",long_format$Date_from[1],".csv"))
  
  write.csv(long_format,paste0("C:/Users/Josh.Andrews/OneDrive - Department of Health and Social Care/wf/Cross-cutting work/Brexit/Nursing/LTP/PMIU work - 2019 elections/Tracking 50k/Dashboard/Data for dashboard/ESR Trust Joiner/",str_replace_all(Sys.Date(),"-",""),"_joiners_leavers_trust",long_format$Date_from[1],".csv"))
  
}
nurse_stock_headcount <- function() {
  #Amend column names so the dots are replaced with spaces
  colnames(Raw_Data_y2) <- str_replace_all(colnames(Raw_Data_y2), " ", "_")
  colnames(nationality) <- str_replace_all(colnames(nationality), " ", "_")
  ...
  #Extract csv
  write.csv(summary, paste("C:/Users/Josh.Andrews/OneDrive - Department of Health and Social Care/Nurse Data/Outputs/Nurses/Nurse",str_replace_all(Sys.Date(),"-",""),"stock headcount.csv"))
  
}

nurse_stock <- function() {
  #Amend column names so the dots are replaced with spaces
  colnames(Raw_Data_y2) <- str_replace_all(colnames(Raw_Data_y2), " ", "_")
  colnames(nationality) <- str_replace_all(colnames(nationality), " ", "_")
  ...
  #Extract csv
  write.csv(summary, paste("C:/Users/Josh.Andrews/OneDrive - Department of Health and Social Care/Nurse Data/Outputs/Nurses/Nurse",str_replace_all(Sys.Date(),"-",""),"stock.csv"))
  
  write.csv(summary,paste("C:/Users/Josh.Andrews/OneDrive - Department of Health and Social Care/wf/Cross-cutting work/Brexit/Nursing/LTP/PMIU work - 2019 elections/Tracking 50k/Dashboard/Data for dashboard/ESR Stock/Nurse",str_replace_all(Sys.Date(),"-",""),"stock.csv"))
